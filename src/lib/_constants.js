...
let logoFooter = " rounded-full' viewBox='0 0 36 36'><path d='M31.42 9.09l-13-6a1 1 0 00-.84 0l-13 6A1 1 0 004 10v17a1 1 0 00.58.91l13 6a1 1 0 00.84 0l13-6A1 1 0 0032 27V10a1 1 0 00-.58-.91zM18 14.9L7.39 10 18 5.1 28.61 10zm12 11.46l-11 5.08v-14.8l11-5.08z' /></svg>"
...
const icons = {
	...
	blackLogo: blackLogo,
  github:
   iconHeader + "M9 19c-4.3 1.4 -4.3 -2.5 -6 -3m12 5v-3.5c0 -1 .1 -1.4 -.5 -2c2.8 -.3 5.5 -1.4 5.5 -6a4.6 4.6 0 0 0 -1.3 -3.2a4.2 4.2 0 0 0 -.1 -3.2s-1.1 -.3 -3.5 1.3a12.3 12.3 0 0 0 -6.2 0c-2.4 -1.6 -3.5 -1.3 -3.5 -1.3a4.2 4.2 0 0 0 -.1 3.2a4.6 4.6 0 0 0 -1.3 3.2c0 4.6 2.7 5.7 5.5 6c-.6 .6 -.6 1.2 -.5 2v3.5" + iconFooter,
  twitter:
    iconHeader + "M22 4.01c-1 .49 -1.98 .689 -3 .99c-1.121 -1.265 -2.783 -1.335 -4.38 -.737s-2.643 2.06 -2.62 3.737v1c-3.245 .083 -6.135 -1.395 -8 -4c0 0 -4.182 7.433 4 11c-1.872 1.247 -3.739 2.088 -6 2c3.308 1.803 6.913 2.423 10.034 1.517c3.58 -1.04 6.522 -3.723 7.651 -7.742a13.84 13.84 0 0 0 .497 -3.753c-.002 -.249 1.51 -2.772 1.818 -4.013z" + iconFooter,
  instagram:
    iconHeader + "M16.5 7.5v.001M15 12a3 3 0 01-3 3 3 3 0 01-3-3 3 3 0 013-3 3 3 0 013 3zM8 4h8c2.216 0 4 1.784 4 4v8c0 2.216-1.784 4-4 4H8c-2.216 0-4-1.784-4-4V8c0-2.216 1.784-4 4-4z" + iconFooter,
  pinterest:
    iconHeader + "M21 12a9 9 0 01-9 9 9 9 0 01-9-9 9 9 0 019-9 9 9 0 019 9zm-10.3 2c.44 1.26 1.43 2 2.55 2 2.07 0 3.75-1.55 3.75-4a5 5 0 10-9.7 1.7M8 20l4-9" + iconFooter,
...
export default { randomNumber, icons};